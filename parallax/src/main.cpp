...
static void display_callback()
{
 ...
 shader->set("parallax_mapping", parallax_mapping);
...
{
  // Load textures
  texture_diffuse = get_texture("brick_diffuse.ppm");
  texture_normal  = get_texture("brick_normal.ppm");
  texture_height  = get_texture("brick_height.ppm");

  // Setup and compile our shaders
  shader = new Shader();
  shader->attach_vertex_from_file("parallax.vert");
  shader->attach_fragment_from_file("parallax.frag");
